          ...
          <div className="flex flex-col gap-6 md:pr-40">
            ...
            <ul className="list-disc ml-4 text-white">
              <li className="p-semibold-18">
                Users must register an account with point.game in order to do
                the following:
              </li>
            ...
            <ul className="list-disc ml-4 text-white">
              <li className="p-regular-18">
                point.game allows users to start or join recreational leagues
              ...
              <ul className="ml-8">
                ...
                <li>
                  Admins must enter the user's point.game username, and press
