...
const Comments = ({
  ...
  return (
    <>
      {data.length > 0 ? (
        <div className="flex flex-col items-center gap-10 bg-blue pt-5 pb-5 px-5">
        ...
        <div className="flex-center wrapper min-h-[200px] w-full flex-col  bg-blue/50 py-28 text-center">
