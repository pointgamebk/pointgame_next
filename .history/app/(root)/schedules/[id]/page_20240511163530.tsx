...
const ScheduleDetails: React.FC<ScheduleDetailsProps> = async ({
  ...
  return (
    <>
      ...
      {isAdmin && (
        <section className="flex justify-center bg-blue bg-dotted-pattern bg-contain px-10">
        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500">
              <th className="min-w-[100px] pr-4 py-4 text-left text-grey-400">
                Team 1
              </th>
                ...
                {matches &&
                  matches.map((row: IMatch) => (
                    ...
                    >
                      ...
                      {isAdmin ? (
                        <td className="min-w-[100px] pr-4 text-green">
                          <UnsetWinner
                            matchId={row._id}
