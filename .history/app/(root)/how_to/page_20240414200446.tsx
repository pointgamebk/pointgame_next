      ...
      <section className="flex justify-center bg-blue bg-dotted-pattern bg-contain">
        <div className="flex w-full flex-col gap-8 p-5 md:p-10">
          <div className="flex flex-col gap-6 md:pr-40">
            ...
            <ul className="list-disc text-white p-regular-20">
              <li>
                &#x2022; Games are displayed on the homepage, ordered based on
                start date ascending
              </li>
              <li>
                &#x2022; &#x2022; Clicking on a game card displayed on the
                homepage will take you to a page further detailing the selected
                game, along with a visual map of the game's location
              </li>
              <li>
