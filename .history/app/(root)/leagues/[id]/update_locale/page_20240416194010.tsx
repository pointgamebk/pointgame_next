  ...
  return (
    <>
      <section className=" bg-dotted-pattern bg-cover bg-center py-5 md:py-10">
        <h3 className="wrapper h4-bold text-center sm:text-left text-white">
          Update <span className="text-green">{league.name}</span> Locale
        </h3>
      </section>

      {isAdmin ? (
        <div className="wrapper my-8 md:px-20">
