          ...
          {isDemoUser && (
            <div className="p-regular-20 flex items-center gap-3 text-green">
              {/* <Link href="/how_to">
                ...
                How To PointGame guide for instructions on how to post or join
                an existing game!
              </Link>{" "} */}
              <p className="p-medium-16 lg:p-regular-18 text-red">
                This post is for demonstration purposes only. Please check the{" "}
                <Link href="/how_to">How To PointGame</Link> guide for
                instructions on how to post or join an existing game!
              </p>
            </div>
          )}
